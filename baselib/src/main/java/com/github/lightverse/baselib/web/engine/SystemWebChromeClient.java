...
import com.github.lightverse.baselib.web.CordovaDialogsHelper;
...
public class SystemWebChromeClient extends WebChromeClient {
    ...
    {
        CoLog.d(LOG_TAG, "onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", estimatedSize, currentQuota, totalUsedQuota);
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage)
    {
        if (consoleMessage.message() != null)
            CoLog.d(LOG_TAG, "%s: Line %d : %s" , consoleMessage.sourceId() , consoleMessage.lineNumber(), consoleMessage.message());
...
//                CoLog.d(LOG_TAG, "Receive file chooser URL: " + result);
...
//            CoLog.w("No activity found to handle file chooser intent.", e);
...
//    }
    ...
    public void onPermissionRequest(final PermissionRequest request) {
        CoLog.d(LOG_TAG, "onPermissionRequest: " + Arrays.toString(request.getResources()));
