...
package com.github.lightverse.baselib.web.engine;
...
import com.github.lightverse.baselib.web.CordovaBridge;
import com.github.lightverse.baselib.web.CordovaInterface;
import com.github.lightverse.baselib.web.CordovaPreferences;
import com.github.lightverse.baselib.web.CordovaWebView;
import com.github.lightverse.baselib.web.CordovaWebViewEngine;
import com.github.lightverse.baselib.web.ICordovaCookieManager;
import com.github.lightverse.baselib.web.JsToNativeManager;
import com.github.lightverse.baselib.web.NativeToJsMessageQueue;
...
public class SystemWebViewEngine implements CordovaWebViewEngine {
    ...
    protected JsToNativeManager pluginManager;
//    protected CordovaResourceApi resourceApi;
    ...
    public void init(CordovaWebView parentWebView, CordovaInterface cordova, CordovaWebViewEngine.Client client,
              JsToNativeManager pluginManager,
...
//        this.resourceApi = resourceApi;
    ...
    private void initWebViewSettings() {
        ...
        CoLog.d(TAG, "CordovaWebView is running on device made by: " + manufacturer);
    ...
    private void enableRemoteDebugging() {
        try {
            ...
            CoLog.d(TAG, "You have one job! To turn on Remote Web Debugging! YOU HAVE FAILED! ");
            e.printStackTrace();
        }
    }
    ...
    public void destroy() {
        ...
        if (receiver != null) {
            try {
                ...
                CoLog.e(TAG, "Error unregistering configuration receiver: " + e.getMessage(), e);
            }
        }
    }
