...
//                    public void run() {
//                        webView.getJsToNativeManager().postMessage("spinner", "stop");
//                    }
//                });
            }
    ...
    public void loadUrl(String url, JSONObject props) throws JSONException {
        CoLog.d("App", "App.loadUrl("+url+","+props+")");
        int wait = 0;
    ...
    public void overrideBackbutton(boolean override) {
        CoLog.i("App", "WARNING: Back Button Default Behavior will be overridden.  The backbutton event will be fired!");
    ...
    public void overrideButton(String button, boolean override) {
        CoLog.i("App", "WARNING: Volume Button Default Behavior will be overridden.  The volume event will be fired!");
     ...
     */
    public void exitApp() {
//        this.webView.getJsToNativeManager().postMessage("exit", null);
    }
                ...
                if ((intent != null) && intent.getAction().equals(TelephonyManager.ACTION_PHONE_STATE_CHANGED)) {
                    if (intent.hasExtra(TelephonyManager.EXTRA_STATE)) {
                        ...
                        if (extraData.equals(TelephonyManager.EXTRA_STATE_RINGING)) {
                            CoLog.i(TAG, "Telephone RINGING");
//                            webView.getJsToNativeManager().postMessage("telephone", "ringing");
                        }
                        else if (extraData.equals(TelephonyManager.EXTRA_STATE_OFFHOOK)) {
                            CoLog.i(TAG, "Telephone OFFHOOK");
//                            webView.getJsToNativeManager().postMessage("telephone", "offhook");
                        }
                        else if (extraData.equals(TelephonyManager.EXTRA_STATE_IDLE)) {
                            CoLog.i(TAG, "Telephone IDLE");
//                            webView.getJsToNativeManager().postMessage("telephone", "idle");
                        }
                    }
                }
            }
    ...
    private void sendEventMessage(String action) {
        ...
        try {
            ...
            CoLog.e(TAG, "Failed to create event message", e);
        }
    ...
    public static Object getBuildConfigValue(Context ctx, String key)
    {
        try
        {
            ...
            CoLog.d(TAG, "Unable to get the BuildConfig, is this built with ANT?");
            e.printStackTrace();
        } catch (NoSuchFieldException e) {
            CoLog.d(TAG, key + " is not a valid field. Check your build.gradle");
        } catch (IllegalAccessException e) {
            CoLog.d(TAG, "Illegal Access Exception: Let's print a stack trace.");
            e.printStackTrace();
        }
