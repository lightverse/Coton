...
import com.github.lightverse.baselib.web.CoreAndroid;
import com.github.lightverse.baselib.web.JsToNativeManager;
import com.github.lightverse.baselib.web.PluginResult;
...
//    }
     ...
     */
    public void onCordovaInit(JsToNativeManager pluginManager) {
        ...
        if (savedResult != null) {
            ...
            {
                CoreAndroid appPlugin = pluginManager.getCoreAndroid();
                if(appPlugin != null) {
...
//
//        if (callback != null) {
//            CoLog.d(TAG, "Sending activity result to plugin");
//            initCallbackService = null;
//            savedResult = null;
//            callback.onActivityResult(requestCode, resultCode, intent);
//            return true;
//        }
        CoLog.w(TAG, "Got an activity result, but no plugin was registered to receive it" + (savedResult != null ? " yet!" : "."));
        return false;
    }
